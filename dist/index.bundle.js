...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_styles_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles/styles.less */ \"./src/styles/styles.less\");\n/* harmony import */ var _modules_validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/validator */ \"./src/modules/validator.js\");\n/* harmony import */ var _modules_toggle_password__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/toggle-password */ \"./src/modules/toggle-password.js\");\n\n\n // Все формы, которые должны валидироваться\n\nvar forms = document.querySelectorAll('[data-validated]');\n(0,_modules_validator__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(forms); // Все элементы с паролями\n\nvar passwords = document.querySelectorAll('.form-password');\n(0,_modules_toggle_password__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(passwords);\n\n//# sourceURL=webpack://webpack/./src/index.js?");

/***/ }),

/***/ "./src/modules/toggle-password.js":
/*!****************************************!*\
  !*** ./src/modules/toggle-password.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n// Настройки\nvar settings = {\n  hiddenClass: 'is-hidden',\n  shownClass: 'is-shown',\n  button: '[data-toggle]'\n}; // Изменить тип у инпута\n\nvar toggleType = function toggleType(input) {\n  var currentType = input.type;\n  input.type = currentType === 'password' ? 'text' : 'password';\n}; // Изменить класс\n\n\nvar toggleClass = function toggleClass(password) {\n  password.classList.toggle(settings.hiddenClass);\n  password.classList.toggle(settings.shownClass);\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (passwords) {\n  passwords.forEach(function (password) {\n    var button = password.querySelector(settings.button);\n    var input = password.querySelector('input');\n    button.addEventListener('click', function (event) {\n      toggleClass(password);\n      toggleType(input);\n    });\n  });\n});\n\n//# sourceURL=webpack://webpack/./src/modules/toggle-password.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n// Настройки\nvar settings = {\n  inputErrorClass: 'form-field_error',\n  inputSuccessClass: 'form-field_success',\n  inputWrapper: '.form-group',\n  errorMessage: '.form-error'\n}; // Получить элемент с текстом ошибки\n\nvar getErrorMessageElement = function getErrorMessageElement(input) {\n  var inputWrapper = input.closest(settings.inputWrapper);\n  var messageElement = inputWrapper.querySelector(settings.errorMessage);\n  return messageElement;\n}; // Показать ошибку для невалидного поля\n\n\nvar showError = function showError(input, message) {\n  input.classList.remove(settings.inputSuccessClass);\n  input.classList.add(settings.inputErrorClass);\n  var messageElement = getErrorMessageElement(input);\n  messageElement.textContent = message;\n  messageElement.style.display = 'block';\n}; // Подсветить валидное поле\n\n\nvar showSuccess = function showSuccess(input) {\n  input.classList.remove(settings.inputErrorClass);\n  input.classList.add(settings.inputSuccessClass);\n  var messageElement = getErrorMessageElement(input);\n\n  if (messageElement) {\n    messageElement.textContent = '';\n    messageElement.style.display = 'none';\n  }\n}; // Проверка поля на пустое значение\n\n\nvar isEmpty = function isEmpty(input) {\n  return input.value.trim() === '';\n}; // Проверить совпадение значений полей\n\n\nvar isEqualValid = function isEqualValid(input) {\n  var comparedInputSelector = input.dataset.equalTo;\n  var comparedInput = document.querySelector(comparedInputSelector);\n  var isValid = input.value === comparedInput.value;\n  return isValid;\n}; // Проверить email\n\n\nvar isEmailValid = function isEmailValid(input) {\n  var regex = /^(([^<>()[\\]\\\\.,;:\\s@\\\"]+(\\.[^<>()[\\]\\\\.,;:\\s@\\\"]+)*)|(\\\".+\\\"))@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\])|(([a-zA-Z\\-0-9]+\\.)+[a-zA-Z]{2,}))$/;\n  return input.value.match(regex);\n}; // Проверить поле на максимальную длину\n\n\nvar isMaxLengthValid = function isMaxLengthValid(input) {\n  var maxLength = input.dataset.maxLength;\n  var isValid = input.value.length <= parseInt(maxLength);\n  return isValid;\n}; // Проверить поле на минимальную длину\n\n\nvar isMinLengthValid = function isMinLengthValid(input) {\n  var minLength = input.dataset.minLength;\n  var isValid = input.value.length >= parseInt(minLength);\n  return isValid;\n}; // Проверить поле на обязательность заполнения\n\n\nvar isRequiredValid = function isRequiredValid(input) {\n  var isRequired = input.dataset.required;\n  var isInvalid = isRequired && isEmpty(input);\n  var isValid = !isInvalid;\n  return isValid;\n}; // Правила валидации\n\n\nvar rules = {\n  required: {\n    isValid: isRequiredValid,\n    defaultMessage: 'Поле обязательно для заполнения'\n  },\n  minLength: {\n    isValid: isMinLengthValid,\n    defaultMessage: 'Значение слишком короткое'\n  },\n  maxLength: {\n    isValid: isMaxLengthValid,\n    defaultMessage: 'Значение слишком длинное'\n  },\n  email: {\n    isValid: isEmailValid,\n    defaultMessage: 'Праверьте правильность ввода электронной почты'\n  },\n  equalTo: {\n    isValid: isEqualValid,\n    defaultMessage: 'Значение полей не совпадают'\n  }\n}; // Получить текст сообщения об ошибке\n\nvar getErrorMessageText = function getErrorMessageText(input, rule) {\n  var defaultMessage = rules[rule].defaultMessage;\n  var customMessage = input.dataset[\"\".concat(rule, \"Message\")];\n  return customMessage !== null && customMessage !== void 0 ? customMessage : defaultMessage;\n}; // Обработчик события отправки формы\n\n\nvar formSubmitHandler = function formSubmitHandler(event) {\n  event.preventDefault();\n  var form = event.target;\n  var inputs = form.querySelectorAll('input, textarea');\n  var isFormValid = true;\n  inputs.forEach(function (input) {\n    var ruleNames = Object.keys(rules);\n\n    for (var _i = 0, _ruleNames = ruleNames; _i < _ruleNames.length; _i++) {\n      var rule = _ruleNames[_i];\n      var hasInputRule = input.dataset[rule];\n\n      if (hasInputRule) {\n        var isValid = rules[rule].isValid;\n\n        if (isValid(input)) {\n          showSuccess(input);\n        } else {\n          isFormValid = false;\n          var message = getErrorMessageText(input, rule);\n          showError(input, message);\n          break;\n        }\n      }\n    }\n  });\n\n  if (isFormValid) {// Ура,орма прошла валидацию, можно отправлять данные на сервер\n  }\n}; // Функция инициализации\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (forms) {\n  forms.forEach(function (form) {\n    form.addEventListener('submit', function (event) {\n      formSubmitHandler(event);\n    });\n  });\n});\n\n//# sourceURL=webpack://webpack/./src/modules/validator.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/getUrl.js */ \"./node_modules/css-loader/dist/runtime/getUrl.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__);\n// Imports\n\n\n\nvar ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../images/night-gradient.svg */ \"./src/images/night-gradient.svg\"), __webpack_require__.b);\nvar ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../images/icon-eye-hide.svg */ \"./src/images/icon-eye-hide.svg\"), __webpack_require__.b);\nvar ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ../images/icon-eye-show.svg */ \"./src/images/icon-eye-show.svg\"), __webpack_require__.b);\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\nvar ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);\nvar ___CSS_LOADER_URL_REPLACEMENT_1___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_1___);\nvar ___CSS_LOADER_URL_REPLACEMENT_2___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_2___);\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, \"@font-face {\\n  font-family: 'Roboto';\\n  font-style: normal;\\n  font-weight: 400;\\n  font-display: swap;\\n  src: url(https://fonts.gstatic.com/s/roboto/v30/KFOmCnqEu92Fr1Me5Q.ttf) format('truetype');\\n}\\n@font-face {\\n  font-family: 'Roboto';\\n  font-style: normal;\\n  font-weight: 500;\\n  font-display: swap;\\n  src: url(https://fonts.gstatic.com/s/roboto/v30/KFOlCnqEu92Fr1MmEU9vAw.ttf) format('truetype');\\n}\\n@font-face {\\n  font-family: 'Roboto';\\n  font-style: normal;\\n  font-weight: 700;\\n  font-display: swap;\\n  src: url(https://fonts.gstatic.com/s/roboto/v30/KFOlCnqEu92Fr1MmWUlvAw.ttf) format('truetype');\\n}\\n@font-face {\\n  font-family: 'Roboto';\\n  font-style: normal;\\n  font-weight: 900;\\n  font-display: swap;\\n  src: url(https://fonts.gstatic.com/s/roboto/v30/KFOlCnqEu92Fr1MmYUtvAw.ttf) format('truetype');\\n}\\n* {\\n  box-sizing: border-box;\\n  font-family: 'Roboto', sans-serif;\\n}\\nhtml {\\n  font-size: 20px;\\n  text-size-adjust: none;\\n}\\nbody {\\n  background: #404157 url(\" + ___CSS_LOADER_URL_REPLACEMENT_0___ + \") no-repeat 50% 50%;\\n  background-size: cover;\\n  color: #2F3041;\\n  line-height: normal;\\n  padding: 1.5rem 1rem;\\n  margin: 0;\\n  min-height: 100vh;\\n  display: flex;\\n  flex-direction: column;\\n  align-items: center;\\n  justify-content: center;\\n}\\n.button {\\n  display: block;\\n  width: 100%;\\n  height: 2.2rem;\\n  border-radius: 1.1rem;\\n  border: none;\\n  background: linear-gradient(to right, #31B9FF, #9BEADA, #9BEADA, #31B9FF);\\n  background-size: 200% 100%;\\n  color: #2D4775;\\n  font-size: 0.8rem;\\n  text-align: center;\\n  font-weight: 700;\\n  letter-spacing: 0.02em;\\n  box-shadow: 0 0.5rem 1.5rem rgba(155, 234, 218, 0.5), 0 3px rgba(0, 0, 0, 0.4);\\n  cursor: pointer;\\n}\\n@media (hover: hover) {\\n  .button {\\n    transition: background 0.3s;\\n  }\\n  .button:hover {\\n    background-position: 100% 0;\\n  }\\n}\\ninput:-webkit-autofill,\\ninput:-webkit-autofill:hover,\\ninput:-webkit-autofill:focus,\\ninput:-webkit-autofill:active {\\n  -webkit-background-clip: text;\\n}\\ninput:-webkit-autofill {\\n  -webkit-text-fill-color: #fff !important;\\n}\\n.form-label {\\n  display: block;\\n  font-size: 0.7rem;\\n  letter-spacing: 0.04em;\\n  color: rgba(255, 255, 255, 0.4);\\n  margin: 0 0 0.5em 1rem;\\n}\\n.form-field {\\n  display: block;\\n  width: 100%;\\n  min-height: 2.2rem;\\n  border-radius: 1.1rem;\\n  border: solid 1px rgba(255, 255, 255, 0.15);\\n  background: linear-gradient(rgba(255, 255, 255, 0.02), rgba(255, 255, 255, 0.1));\\n  -webkit-backdrop-filter: blur(4rem) saturate(180%);\\n  backdrop-filter: blur(4rem) saturate(180%);\\n  color: #fff;\\n  font-size: 0.7rem;\\n  font-weight: 400;\\n  letter-spacing: 0.04em;\\n  padding: 0 1rem;\\n  box-shadow: 0 0.5rem 1.5rem rgba(0, 0, 0, 0.15);\\n  outline: none;\\n}\\n.form-field::placeholder {\\n  color: rgba(255, 255, 255, 0.7);\\n  opacity: 1;\\n}\\n.form-field:-ms-input-placeholder {\\n  color: rgba(255, 255, 255, 0.7);\\n}\\n.form-field::-ms-input-placeholder {\\n  color: rgba(255, 255, 255, 0.7);\\n}\\n.form-icon {\\n  width: 1.8rem;\\n  height: 1.8rem;\\n  border-radius: 50%;\\n  background: rgba(255, 255, 255, 0.1);\\n  display: flex;\\n  align-items: center;\\n  justify-content: center;\\n}\\n.form-field:focus + .form-icon {\\n  background: rgba(255, 255, 255, 0.2);\\n}\\n.form-icon svg {\\n  display: block;\\n  width: 55%;\\n  height: 55%;\\n}\\n.form-icon path,\\n.form-icon polygon {\\n  fill: rgba(255, 255, 255, 0.5);\\n}\\n.form-icon path.stroke,\\n.form-icon polygon.stroke {\\n  fill: none;\\n  stroke: rgba(255, 255, 255, 0.5);\\n  stroke-width: 2;\\n  stroke-linecap: round;\\n  stroke-linejoin: round;\\n  stroke-miterlimit: 10;\\n}\\n.form-field:focus + .form-icon path,\\n.form-field:focus + .form-icon polygon {\\n  fill: #fff;\\n}\\n.form-field:focus + .form-icon path.stroke,\\n.form-field:focus + .form-icon polygon.stroke {\\n  fill: none;\\n  stroke: #fff;\\n}\\n.form-field_error + .form-icon path,\\n.form-field_error + .form-icon polygon {\\n  fill: #ff7a8e;\\n}\\n.form-field_error + .form-icon path.stroke,\\n.form-field_error + .form-icon polygon.stroke {\\n  fill: none;\\n  stroke: #ff6b81;\\n}\\n.form-field_success + .form-icon path,\\n.form-field_success + .form-icon polygon {\\n  fill: #1dd2af;\\n}\\n.form-field_success + .form-icon path.stroke,\\n.form-field_success + .form-icon polygon.stroke {\\n  fill: none;\\n  stroke: #1abc9c;\\n}\\n.form-icon-field {\\n  position: relative;\\n}\\n.form-icon-field .form-icon {\\n  position: absolute;\\n  left: 0.2rem;\\n  top: 0.2rem;\\n}\\n.form-icon-field .form-field {\\n  padding-left: 2.7rem;\\n}\\n.form-password {\\n  position: relative;\\n}\\n.form-password .form-field {\\n  padding-right: 2.5rem;\\n}\\n.form-password__button {\\n  width: 2.2rem;\\n  height: 2.2rem;\\n  position: absolute;\\n  right: 0;\\n  top: 0;\\n  display: flex;\\n  align-items: center;\\n  justify-content: center;\\n  border: none;\\n  overflow: hidden;\\n  text-indent: -1000px;\\n  opacity: 0.5;\\n  cursor: pointer;\\n  background: none;\\n}\\n.form-password__button:before,\\n.form-password__button:after {\\n  content: '';\\n  display: none;\\n  position: absolute;\\n  left: 0;\\n  top: 0;\\n  width: 100%;\\n  height: 100%;\\n  background: no-repeat 50% 50%;\\n  background-size: 45% 45%;\\n}\\n.form-password__button:before {\\n  background-image: url(\" + ___CSS_LOADER_URL_REPLACEMENT_1___ + \");\\n}\\n.form-password__button:after {\\n  background-image: url(\" + ___CSS_LOADER_URL_REPLACEMENT_2___ + \");\\n}\\n.form-password.is-shown .form-password__button:before {\\n  display: block;\\n}\\n.form-password.is-hidden .form-password__button:after {\\n  display: block;\\n}\\n@media (hover: hover) {\\n  .form-password__button:hover {\\n    opacity: 1;\\n  }\\n}\\n.form-error {\\n  color: #ff6b81;\\n  font-size: 0.7rem;\\n  letter-spacing: 0.04em;\\n  margin: 0.5em 0 0 1rem;\\n  display: none;\\n}\\n.form-group {\\n  margin: 0 0 0.75rem;\\n}\\n.form {\\n  background: rgba(255, 255, 255, 0.07);\\n  border-radius: 0.5rem;\\n  -webkit-backdrop-filter: blur(0.3rem) saturate(120%);\\n  backdrop-filter: blur(0.3rem) saturate(120%);\\n  border: solid 2px rgba(225, 225, 225, 0.15);\\n  border-bottom: none;\\n  border-left-color: rgba(225, 225, 225, 0.05);\\n  border-right-color: rgba(225, 225, 225, 0.1);\\n  border-right-width: 1px;\\n  width: 100%;\\n  max-width: 20rem;\\n  padding: 1.5rem 2rem 2.5rem;\\n  color: #fff;\\n}\\n.form__title {\\n  margin: 0 0 1.25em;\\n  text-align: center;\\n  font-size: 1.2rem;\\n  line-height: 1;\\n  font-weight: 700;\\n  letter-spacing: 0.02em;\\n}\\n.form__submit {\\n  margin: 1.5rem 0 0;\\n}\\n@media (max-width: 768px) {\\n  .form {\\n    padding-left: 1rem;\\n    padding-right: 1rem;\\n  }\\n}\\n\", \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack://webpack/./src/styles/styles.less?./node_modules/css-loader/dist/cjs.js!./node_modules/less-loader/dist/cjs.js");
...
/***/ "./src/images/icon-eye-hide.svg":
/*!**************************************!*\
  !*** ./src/images/icon-eye-hide.svg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"9b62870194565bfa2232.svg\";\n\n//# sourceURL=webpack://webpack/./src/images/icon-eye-hide.svg?");

/***/ }),

/***/ "./src/images/icon-eye-show.svg":
/*!**************************************!*\
  !*** ./src/images/icon-eye-show.svg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"2d21a0186d6b26641428.svg\";\n\n//# sourceURL=webpack://webpack/./src/images/icon-eye-show.svg?");

/***/ }),

/***/ "./src/images/night-gradient.svg":
/*!***************************************!*\
  !*** ./src/images/night-gradient.svg ***!
  \***************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"4e8b0a3e47876b737887.svg\";\n\n//# sourceURL=webpack://webpack/./src/images/night-gradient.svg?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("698a27e72774d1efe151")
/******/ 	})();
/******/ 	
